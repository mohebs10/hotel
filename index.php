          ...
          <div class="col-md-7">
            <div class="media d-block room mb-0">
              ...
              <div class="media-body">
                <h3 class="mt-0"><a href="#">common Room</a></h3>
                <ul class="room-specs">
                  <li><span class="ion-ios-people-outline"></span> up to 5 Guests</li>
                  
                </ul>
                <p>Nulla vel metus scelerisque ante sollicitudin. Fusce condimentum nunc ac nisi vulputate fringilla. </p>
                <p><a href="booknow.php" class="btn btn-primary btn-sm">Book Now </a></p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row justify-content-center align-items-center intro">
          <div class="col-md-9 text-center element-animate">
            ...
            <h2 style="color: #c09365;">Relax and Enjoy your Holiday</h2>
            <p class="lead mb-5" style="color: #c09365;">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto quidem tempore expedita facere facilis, dolores!</p>
          </div>
        </div>
      </div>
    </section>
